...
INFO_PANE_HEIGHT = 35
BACKGROUND_COLOR = formatColor(18.0, 18.0, 18.0)
WALL_COLOR = formatColor(0.0, 0.0, 0.0)
INFO_PANE_COLOR = formatColor(33.0, 33.0, 33.0)
...
PACMAN_COLOR = formatColor(82.0, 123.0, 189.0)
PACMAN_SCALE = 0.5
# pacman_speed = 1
...
class InfoPane:
    ...
    def updateScore(self, score):
        changeText(self.scoreText, "Blazlingly fast: % 4d" % score)
